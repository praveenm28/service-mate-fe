    ...
    try {
      ...
      const mockProviders: Provider[] = [
        ...
        },
        {
          ...
          description: "Emergency and scheduled plumbing services with 24/7 availability.",
        ...
        },
        {
          ...
          description: "Complete lawn care, landscaping, and garden maintenance services.",
        ...
        },
        {
          id: "p5",
          name: "Assembly Pros",
          description: "Expert furniture assembly and installation services for home and office.",
        ...
        },
        {
          id: "p8",
          name: "Tech Connect",
          description: "Home technology installation and troubleshooting services.",
        ...
        },
        {
          ...
          description: "Professional locksmith services for residential and commercial properties.",
      ...
      if (filters.category) {
        filteredProviders = filteredProviders.filter((provider) => provider.categories.includes(filters.category))
      }

      if (filters.rating) {
        const minRating =
          filters.rating === "4plus" ? 4 : filters.rating === "4.5plus" ? 4.5 : filters.rating === "5" ? 5 : 0
