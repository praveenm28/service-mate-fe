      ...
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/provider/join" className="text-muted-foreground hover:text-foreground">
                  Become a Provider
                </Link>
              </li>
              <li>
                <Link href="/provider/resources" className="text-muted-foreground hover:text-foreground">
                  Resources
                </Link>
              </li>
              <li>
                <Link href="/provider/community" className="text-muted-foreground hover:text-foreground">
                  Community
                </Link>
              </li>
              <li>
                <Link href="/provider/app" className="text-muted-foreground hover:text-foreground">
                  Provider App
                </Link>
              </li>
            </ul>
